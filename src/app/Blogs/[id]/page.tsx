...
export default function BlogDetail() {
  ...
  return (
    <div
      className={`w-full min-h-screen px-4 sm:px-6 py-10 ${ themeValue ? light : dark}`}>
      <div className="max-w-full sm:max-w-4xl md:max-w-5xl mx-auto">
        ...
        <div className="mb-12 px-2 sm:px-6">
          <h3 className={`text-2xl font-semibold mb-4 ${ themeValue ? lightText : DarkText }`}>
            Content
          </h3>
          <p className={`leading-8 text-justify text-lg ${ themeValue ? lightText : "text-gray-300"}`}>
            {blog.blogContent}
          </p>
        </div>
        ...
        {blog.blogSummary && (
          <div className="mb-12 px-2 sm:px-6">
            ...
            <p className={`leading-7 italic text-lg ${themeValue ? lightText : "text-gray-300" }`}>
              {blog.blogSummary}
            </p>
          </div>
        )}
